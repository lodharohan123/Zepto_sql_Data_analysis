...
2.	git clone https://github.com/amlanmohanty/zepto-SQL-data-analysis-project.git
cd zepto-SQL-data-analysis-project
3.	Open zepto_SQL_data_analysis.sql
This file contains:
o	Table creation
o	Data exploration
o	Data cleaning
o	SQL Business analysis
4.	Load the dataset into pgAdmin or any other PostgreSQL client
o	Create a database and run the SQL file
o	Import the dataset (convert to UTF-8 if necessary)
